...
class PosterCompetitionController extends Controller
{
    ...
    public function register(){
        ...
        return view('postercompe-regis')->with(compact('institution', $institution));
    }
    ...
    public function createStep3(Request $request, $count){
        ...
        $member1 = $request->session()->get('member1');
        $member2 = $request->session()->get('member2');
        return view('couponposter', ['count', $count])
        ->with(compact('papercompe', $papercompe))
        ->with(compact('team_leader', $team_leader))
        ->with(compact('member1', $member1))
        ->with(compact('member2', $member2))
    ...
    public function postCreateStep1(Request $request){
        ...
        return redirect()->route('poster-competition-regis-voucher-get', ['count'=>$count]);
    }
    ...
    public function postCreateStep2(Request $request){
        ...
        return redirect()->route('poster-competition-regis-complete');
    }
    ...
    public function postCreateStep3(Request $request){
        ...
        return redirect()->route('poster-competition-total', ['count' =>$count]);
    }
}
