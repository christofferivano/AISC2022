                    ...
                    @if ($vouchers->count())
                        @foreach ($vouchers as $voucher)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    @if ($voucher->institution)
                                        {{ $voucher->institution->nama_institusi }}
                                    @endif
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a href="{{ route('voucher-edit', $voucher) }} " class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-200 text-white-800">Edit</a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a onClick='javascript:return confirm("Are you sure want to delete {{ $voucher->kode_voucher }} from the registration data list?");' href="{{ route('voucher-delete', $voucher) }} " class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-200 text-red-800">Delete</a>
                            </td>
                            </tr>
                        @endforeach
                    @else
