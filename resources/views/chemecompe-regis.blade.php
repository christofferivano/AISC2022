    ...
    <div class="pt-32 md:grid md:grid-cols-5 pb-96 md:pb-32 md:w-full">
        <div class="md:col-span-2 md:col-start-1 pl-1 md:pl-24 flex flex-col items-start md:w-full">
            ...
            <div class="w-72 md:w-full pt-2 md:pt-0 md:pr-5 z-10">
                <form action="{{ route('cheme-competition-regis') }}" method="POST" class="flex flex-col pt-10 md:pt-12">
                    @csrf
                    ...
                    <div id="other_column" class="hidden flex flex-col md:flex-row">
                        <div class="flex flex-col">
                            ...
                            <input value="{{{ $team_leader->institution ?? '' }}}" name="other_place" type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">
                        </div>
                        @error('other_place')
                                <div class="text-red-500 mt-2 text-sm">
                    ...
                    <input type="hidden" name="jenis" value="Cheme">
                    ...
                    <div id="other_column1" class="hidden flex flex-col md:flex-row">
                        <div class="flex flex-col">
                            ...
                            <input value="{{{ $member1->institution ?? '' }}}" name="other_place1" type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">
                        </div>
                        @error('other_place1')
                                <div class="text-red-500 mt-2 text-sm">
                                    The Institution is required!
                    ...
                    <div id="other_column2" class="hidden flex flex-col md:flex-row">
                        <div class="flex flex-col">
                            ...
                            <input value="{{{ $member2->institution ?? '' }}}" name="other_place2" type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">
                        </div>
                        @error('other_place2')
                                <div class="text-red-500 mt-2 text-sm">
                                    The Institution is required!
                    ...
                    <div class="flex flex-col md:flex-row">
                        <div class="flex flex-col">
                                ...
                                <input value="{{{ $member3->nama ?? '' }}}" name="member3" type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">
                        </div>
                        <div class="flex flex-col px-0 md:px-10">
                            <label for="place3" class="pt-10 pb-2 pl-4 text-base md:text-xl font-medium">Institution/University*</label>
                            {{-- <input value="{{{ $member2->institution ?? '' }}}" name="place2" type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">  --}}
                            <select id="place3" name="place3" for="place3" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">
                                <option class="py-1 font-sans" disabled selected hidden>Select University/Institution</option>
                                @foreach ($institution as $i)
                                    <option class="py-1 font-sans">{{ $i->nama_institusi }}</option>
                                @endforeach
                    ...
                    <div id="other_column3" class="hidden flex flex-col md:flex-row">
                        <div class="flex flex-col">
                            <label for="other_place3" class="pt-10 pb-2 pl-4 text-base md:text-xl font-medium">Member 3 Institution*</label>
                            <input value="{{{ $member3->institution ?? '' }}}" name="other_place3" type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 md:w-80 text-sm focus:ring-2 focus:ring-form" placeholder="">
                        </div>
                        @error('other_place3')
                                <div class="text-red-500 mt-2 text-sm">
                                    The Institution is required!
