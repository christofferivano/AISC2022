                        ...
                        @foreach ($institution as $institute)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    {{ $institute->nama_institusi }}
                                    </div>
                                </div>
                            </td>
                            
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a href="{{ route('institution-edit', $institute) }} " class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-200 text-white-800">Edit</a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a onClick='javascript:return confirm("Are you sure want to delete {{ $institute->nama_institusi }} from the registration data list?");' href="{{ route('institution-delete', $institute) }} " class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-200 text-red-800">Delete</a>
                            </td>
                            </tr>
                        @endforeach
                    @else
