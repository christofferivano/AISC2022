        ...
        <div class="col-span-2 col-start-1 pl-24 flex flex-col items-start">
            ...
            <div class="z-10">
                <form action="" class="flex flex-col pt-12">
                    ...
                    <input type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 text-sm focus:ring-2 focus:ring-form" placeholder="Your Name">
                    ...
                    <input type="text" class="outline-none rounded-full border border-form py-1 px-4 w-96 text-sm focus:ring-2 focus:ring-form">
