                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @if ($registration->count())
                        @foreach ($registration as $r)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $r->nama_tim }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @if ($r->payment)
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <a href="{{ route('payment-view', $r->id) }}" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-200 text-blue-800">View</a>
                                </td>
                            @else
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                </td>
                            ...
                            @if ($r->document)
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <a target="#" href="/comperegis_document/{{ $r->document->filename }}" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-200 text-green-800">View</a>
                                </td>
                            @else
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                </td>
                            ...
                            @if($r->members->count())
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <a href="{{ route('members-view', $r->id) }}" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-purple-200 text-purple-800">Members</a>
                                </td>
                            @else
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                </td>
