...
@section('content')
    <div class="hidden md:block absolute left-0 bottom-0 z-0">
        <img src="/images/bulet-aischat-6.png" alt="" class="w-96 -mb-40">
    </div>
    <div class="hidden md:block absolute right-0 bottom-0 z-0">
        <img src="/images/bulet-aischat-7.png" alt="" class="h-96 -mb-40">
    </div>
    ...
    <div class="pt-40 pb-20 flex flex-col items-center justify-center">
        ...
        <form class="w-full max-w-screen-md">
            ...
            <div class="pt-5">
                ...
                <label class="flex flex-col p-4 shadow-md rounded-xl cursor-pointer" for="radio_2">
                    <div class="pr-6 flex flex-row items-center justify-between h-16">
                        <img src="images/ovo.png" alt="" class="h-20">
                        <h2 class="text-2xl font-bold -ml-64 pl-1">OVO</h2>
                        <button type="button" class="rounded-full h-6 w-6 border-2 border-gray-400">
                            <img src="images/ceklis.png" alt="" class="ceklis h-full hidden">
                        </button>
                    </div>
            ...
            <div class="pt-5">
                ...
                <label class="flex flex-col p-4 shadow-md rounded-xl cursor-pointer" for="radio_3">
                    <div class="pr-6 flex flex-row items-center justify-between h-16">
                        <img src="images/gopay.png" alt="" class="h-14">
                        <h2 class="text-2xl font-bold -ml-64">Gopay</h2>
                        <button type="button" class="rounded-full h-6 w-6 border-2 border-gray-400">
                            <img src="images/ceklis.png" alt="" class="ceklis h-full hidden">
                        </button>
                    </div>
            ...
            <div class="pt-5">
                ...
                <label class="flex flex-col p-4 shadow-md rounded-xl cursor-pointer" for="radio_4">
                    <div class="pr-6 flex flex-row items-center justify-between h-16">
            ...
            <div class="flex flex-col items-center pt-20">
                <button type="submit" class="w-96 bg-gradient-to-l from-blue-300 to-purple-400 py-1.5 rounded-full text-white text-lg font-semibold shadow-lg">
                    Next
                </button>
            </div>
        </form>
