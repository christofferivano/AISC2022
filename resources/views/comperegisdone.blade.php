...
@section('content')
    ...
    <div class="pt-28 pl-20 md:pl-97" data-aos="fade-right" data-aos-duration="1500">
        <img src="images/regiscompedone.png" alt="" class="h-64 md:h-140">
    </div>
    <div class="py-5 md:py-20 text-montserrat flex flex-col items-center pb-60" data-aos="fade-right" data-aos-duration="2000"> 
        <h1 class="text-base md:text-4xl font-bold">Thank You for Participating in the Competitions</h1>
        <h1 class="text-base md:text-4xl font-bold pt-1 jusify-center">We Wish You the Best of Luck!</h1>
    </div>
