...
@section('content')
    ...
    <div class="pt-28 pl-0 md:ml-28 md:pl-96" data-aos="fade-right" data-aos-duration="1500">
    ...
    <div class="py-5 md:py-20 text-montserrat flex flex-col items-center pb-60" data-aos="fade-right" data-aos-duration="2000"> 
        <h1 class="text-base md:text-4xl font-bold">Thank You for Keeping up with The Conferences</h1>
