...
@section('content')
    <div class="hidden md:block absolute z-0">
        <img src="/images/bulet-regis-aischat-2.png" alt="" class="w-98 ml-98 pl-20 mt-20">
    </div>
    <div class="pt-32 grid md:grid-cols-5 pb-96 md:pb-32 w-full">
        ...
        <div class="hidden col-span-3 col-start-3 md:flex flex-col items-end">
            ...
            <img src="/images/bg-regis-aischat-2.png" alt="" class="w-5/7 pt-20 z-10">
        </div>
    </div>
    <div class="absolute left-0 -mt-80 z-0">
