...
<body class="relative">
    <div style="background-image: url('images/bg-compe-1.png')" class="bg-cover h-landing bg-local relative h-96 md:h-full">
        <div class="absolute left-0">
            <img src="images/bulet-compe-4.png" alt="" class="h-40 md:h-60 lg:h-80 xl:h-100"> 
        </div>
        <div class="absolute right-0 bottom-60">
            <img src="images/bulet-compe-5.png" alt="" class="h-40 md:h-60 lg:h-80"> 
        </div>
        <!-- <div class="absolute md:bottom-0 right-1/2">
            <img src="images/bulet-compe-6.png" alt="" class="h-40"> 
        </div> -->
